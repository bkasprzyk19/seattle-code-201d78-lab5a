...
function multiply(a, b) { //eslint-disable-line
  let mult = a*b;
  let string = 'The product of ' + a + ' and ' + b + ' is 45.';
  let array = [mult, string];
  return array; 
  }
...
let third = a + ' and ' + b + ' and ' + c + ' sum to ' + sum2[0] + '.';
let fourth = 'The product of ' + a + ' and ' + b + ' and '+ c + ' is ' + mult2[0] + '.';
let array1 = [sum2[0], mult2[0], third, fourth];
return array1; 
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let mult1 = multiply(testArray[0], testArray[1]);
let mult2 = multiply(mult1[0], testArray[2]);
let string2 = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + mult2[0] + '.';
console.log (string2);
return [mult2[0], string2];
}
